...
Event.create({title: "Traceless Arson Training" , user_id: 6, city_id: 13, body:"Come on baby light my fire and also don't get caught!", event_date: "2016-07-01 00:00:00" })
...
Event.create({title: "Ivory Sale" , user_id: 6, city_id: 8, body:"Just a little ivory between friends.", event_date: "2015-05-12 00:00:00" })
...
Event.create({title: "Nuclear Weapons Sale" , user_id: 6, city_id: 6, body:"You'll literally glow with envy when you see these deals.", event_date: "2015-05-11 00:00:00" })
